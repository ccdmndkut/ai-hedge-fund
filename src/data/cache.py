class Cache:
    ...
    def __init__(self):
        ...
        self._option_chains_cache: dict[str, dict[str, list[dict[str, any]]]] = {}
    ...
    def get_option_chain(self, ticker: str) -> dict[str, list[dict[str, any]]] | None:
        """Get cached options chain data if available."""
        return self._option_chains_cache.get(ticker)
    
    def set_option_chain(self, ticker: str, data: dict[str, list[dict[str, any]]]):
        """Store options chain data in cache."""
        # For options data, we just replace the entire chain since it needs to be current
        self._option_chains_cache[ticker] = data
